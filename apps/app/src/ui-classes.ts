...
export const treeRowClass =
  'flex min-h-[1.95rem] w-full items-center gap-2 rounded-[0.55rem] border-0 bg-transparent text-left text-[0.86rem] font-medium text-[var(--color-coda-sidebar-text)] transition-colors [padding-left:calc(0.62rem+(var(--depth,1)*0.82rem))] px-[0.62rem] py-[0.3rem]';
